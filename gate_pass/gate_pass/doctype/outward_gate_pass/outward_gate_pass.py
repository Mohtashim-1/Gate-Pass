...
class OutwardGatePass(Document):
    ...
    def send_outward_gate_to_stock_entry(self):
        ...
        if gate_pass.ogp_type == "Inventory" and gate_pass.type == "Returnable" and gate_pass.workflow_state == "Pending Return":
            stock_entry_items = []
        ...
        elif gate_pass.ogp_type == "Inventory" and gate_pass.type == "Non-Returnable" and gate_pass.workflow_state == "Pending Return":
            stock_entry_items = []
            for item in gate_pass.inventory_gate_pass:
                stock_entry_items.append({
                    'item_code': item.item,
